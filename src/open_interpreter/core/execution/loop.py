...
class InterpreterExecutionLoop:
    """Adapter that exposes the legacy respond loop as a service-friendly API."""
    ...
    def stream(self) -> Generator[Dict[str, Any], None, None]:
        ...
        yield from respond(self._interpreter)


__all__ = ["InterpreterExecutionLoop", "respond"]
