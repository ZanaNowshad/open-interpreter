...
try:
    import shortuuid
except ModuleNotFoundError:  # pragma: no cover - fallback used in tests without extra deps
...
try:
    ...
    class WebSocketState(Enum):  # type: ignore[override]
        CONNECTED = "CONNECTED"

from .runtime import OpenInterpreter
